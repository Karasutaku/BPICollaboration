        ...
        internal bool editEPKRSItemCaseData(QueryModel<EPKRSUploadItemCase> data, DataTable dataItemLines)
        {
            ...
            using (SqlConnection con = new SqlConnection(_conString))
            {
                ...
                try
                {
                    ...
                    //command.Parameters.AddWithValue("@VarianceDate", data.Data.itemCase.VarianceDate);
                    //command.Parameters.AddWithValue("@isLate", data.Data.itemCase.isLate);
                    //command.Parameters.AddWithValue("@isCCTVCoverable", data.Data.itemCase.isCCTVCoverable);
                    //command.Parameters.AddWithValue("@isReportedtoSender", data.Data.itemCase.isReportedtoSender);
