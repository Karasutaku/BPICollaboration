...
namespace BPIWebApplication.Server.Controllers
{
    ...
    public class EPKRSFacade : ControllerBase
    {
        ...
        public async Task<IActionResult> getEPKRSItemCaseData(QueryModel<string> param)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<string>>("api/BR/EPKRS/getEPKRSItemCase", param);
        ...
        public async Task<IActionResult> getEPKRSIncidentAccidentData(QueryModel<string> param)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<string>>("api/BR/EPKRS/getEPKRSIncidentAccident", param);
        ...
        public async Task<IActionResult> getEPKRSGeneralStatistics(QueryModel<string> param)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<string>>("api/BR/EPKRS/getEPKRSGeneralStatistics", param);
        ...
        public async Task<IActionResult> getEPKRSIncidentAccidentDataforStatistics(QueryModel<string> param)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<string>>("api/BR/EPKRS/getEPKRSIncidentAccidentDataforStatistics", param);
        ...
        public async Task<IActionResult> getEPKRSItemCaseCategoryStatistics(QueryModel<string> param)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<string>>("api/BR/EPKRS/getEPKRSItemCaseCategoryStatistics", param);
        ...
        public async Task<IActionResult> getEPKRSTopLocationReportStatistics(QueryModel<string> param)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<string>>("api/BR/EPKRS/getEPKRSTopLocationReportStatistics", param);
        ...
        public async Task<IActionResult> getEPKRSItemCategoriesStatistics(QueryModel<string> param)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<string>>("api/BR/EPKRS/getEPKRSItemCategoriesStatistics", param);
        ...
        public async Task<IActionResult> getEPKRSIncidentAccidentLocationStatistics(QueryModel<string> param)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<string>>("api/BR/EPKRS/getEPKRSIncidentAccidentLocationStatistics", param);
        ...
        public async Task<IActionResult> getEPKRSModuleNumberOfPage(QueryModel<string> param)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<string>>("api/BR/EPKRS/getEPKRSModuleNumberOfPage", param);
