...
namespace BPIWebApplication.Server.Controllers
{
    ...
    public class EPKRSController : ControllerBase
    {
        ...
        private readonly int _maxFileSize, _maxStatRow;
        ...
        public EPKRSController(HttpClient http, IConfiguration config)
        {
            ...
            _maxFileSize = config.GetValue<int>("File:EPKRS:MaxUpload");
            _maxStatRow = config.GetValue<int>("File:EPKRS:MaxStatisticsRow");
        }
        ...
        public async Task<IActionResult> createEPKRSDocumentDiscussionData(DocumentDiscussionStream data)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<DocumentDiscussionStream>($"api/Facade/EPKRS/createEPKRSDocumentDiscussion", data);
        ...
        public async Task<IActionResult> createEPKRSDocumentApprovalData(QueryModel<DocumentApproval> data)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<DocumentApproval>>($"api/Facade/EPKRS/createEPKRSDocumentApproval", data);
        ...
        public async Task<IActionResult> createEPKRSDocumentApprovalExtendedData(QueryModel<RISKApprovalExtended> data)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<RISKApprovalExtended>>($"api/Facade/EPKRS/createEPKRSDocumentApprovalExtended", data);
        ...
        public async Task<IActionResult> editEPKRSItemCase(QueryModel<EPKRSUploadItemCase> data)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<EPKRSUploadItemCase>>($"api/Facade/EPKRS/editEPKRSItemCaseData", data);
        ...
        public async Task<IActionResult> editEPKRSIncidentAccident(QueryModel<IncidentAccident> data)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<IncidentAccident>>($"api/Facade/EPKRS/editEPKRSIncidentAccidentData", data);
        ...
        public async Task<IActionResult> deleteEPKRSItemCaseDocumentData(QueryModel<string> data)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<string>>($"api/Facade/EPKRS/deleteEPKRSItemCaseDocumentData", data);
        ...
        public async Task<IActionResult> deleteEPKRSIncidentAccidentDocumentData(QueryModel<string> data)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<string>>($"api/Facade/EPKRS/deleteEPKRSIncidentAccidentDocumentData", data);
        ...
        public async Task<IActionResult> getEPKRSItemCaseData(QueryModel<string> param)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<string>>("api/Facade/EPKRS/getEPKRSItemCase", param);
        ...
        public async Task<IActionResult> getEPKRSIncidentAccidentData(QueryModel<string> param)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<string>>("api/Facade/EPKRS/getEPKRSIncidentAccident", param);
        ...
        public async Task<IActionResult> getEPKRSDocumentDiscussion(string param)
        {
            ...
            try
            {
                var result = await _http.GetFromJsonAsync<ResultModel<List<DocumentDiscussion>>>($"api/Facade/EPKRS/getEPKRSDocumentDiscussion/{param}");
        ...
        public async Task<IActionResult> getAttachFileStream(string param)
        {
            ...
            try
            {
                var result = await _http.GetFromJsonAsync<ResultModel<List<BPIWebApplication.Shared.MainModel.Stream.FileStream>>>($"api/Facade/EPKRS/getEPKRSFileStream/{param}");
        ...
        [HttpGet("getEPKRSMaxStatisticsRow")]
        public async Task<IActionResult> getEPKRSMaxStatisticsRow()
        {
            ResultModel<int> res = new ResultModel<int>();
            IActionResult actionResult = null;
        ...
        public async Task<IActionResult> getEPKRSGeneralStatistics(QueryModel<string> param)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<string>>("api/Facade/EPKRS/getEPKRSGeneralStatistics", param);
        ...
        public async Task<IActionResult> getEPKRSIncidentAccidentDataforStatistics(QueryModel<string> param)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<string>>("api/Facade/EPKRS/getEPKRSIncidentAccidentDataforStatistics", param);
        ...
        public async Task<IActionResult> getEPKRSGeneralIncidentAccidentStatistics(QueryModel<string> param)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<string>>("api/Facade/EPKRS/getEPKRSGeneralIncidentAccidentStatistics", param);
        ...
        public async Task<IActionResult> getEPKRSItemCaseCategoryStatistics(QueryModel<string> param)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<string>>("api/Facade/EPKRS/getEPKRSItemCaseCategoryStatistics", param);
        ...
        public async Task<IActionResult> getEPKRSTopLocationReportStatistics(QueryModel<string> param)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<string>>("api/Facade/EPKRS/getEPKRSTopLocationReportStatistics", param);
        ...
        public async Task<IActionResult> getEPKRSItemCategoriesStatistics(QueryModel<string> param)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<string>>("api/Facade/EPKRS/getEPKRSItemCategoriesStatistics", param);
        ...
        public async Task<IActionResult> getEPKRSIncidentAccidentRegionalStatisticsbyDORMEmail(QueryModel<string> param)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<string>>("api/Facade/EPKRS/getEPKRSIncidentAccidentRegionalStatisticsbyDORMEmail", param);
        ...
        public async Task<IActionResult> getEPKRSIncidentAccidentInvolverStatisticsbyInvolverPosition(QueryModel<string> param)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<string>>("api/Facade/EPKRS/getEPKRSIncidentAccidentInvolverStatisticsbyInvolverPosition", param);
        ...
        public async Task<IActionResult> getEPKRSIncidentAccidentInvolverStatisticsbyInvolverDept(QueryModel<string> param)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<string>>("api/Facade/EPKRS/getEPKRSIncidentAccidentInvolverStatisticsbyInvolverDept", param);
        ...
        public async Task<IActionResult> getEPKRSIncidentAccidentLocationStatistics(QueryModel<string> param)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<string>>("api/Facade/EPKRS/getEPKRSIncidentAccidentLocationStatistics", param);
        ...
        public async Task<IActionResult> getEPKRSModuleNumberOfPage(QueryModel<string> param)
        {
            ...
            try
            {
                var result = await _http.PostAsJsonAsync<QueryModel<string>>("api/Facade/EPKRS/getEPKRSModuleNumberOfPage", param);
